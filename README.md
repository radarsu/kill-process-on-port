...
[![Greenkeeper badge](https://badges.greenkeeper.io/radarsu/typescript-library-starter.svg)](https://greenkeeper.io/)
[![Travis](https://img.shields.io/travis/radarsu/typescript-library-starter.svg)](https://travis-ci.org/radarsu/typescript-library-starter)
[![Coveralls](https://img.shields.io/coveralls/radarsu/typescript-library-starter.svg)](https://coveralls.io/github/radarsu/typescript-library-starter)
[![Dev Dependencies](https://david-dm.org/radarsu/typescript-library-starter/dev-status.svg)](https://david-dm.org/radarsu/typescript-library-starter?type=dev)
...
```bash
git clone https://github.com/radarsu/typescript-library-starter.git YOURFOLDERNAME
cd YOURFOLDERNAME
...
### Features
 ...
 - **[RollupJS](https://rollupjs.org/)** for multiple optimized bundles following the [standard convention](http://2ality.com/2017/04/setting-up-multi-platform-packages.html) and [Tree-shaking](https://radarsu.github.io/2017/03/06/Tree-shaking-with-Webpack-2-TypeScript-and-Babel/).
